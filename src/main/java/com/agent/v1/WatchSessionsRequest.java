...
public  final class WatchSessionsRequest extends
  ...
  public static com.agent.v1.WatchSessionsRequest parseFrom(
  ...
  public static com.agent.v1.WatchSessionsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.agent.v1.WatchSessionsRequest parseFrom(java.io.InputStream input)
  ...
  public static com.agent.v1.WatchSessionsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }

  public static com.agent.v1.WatchSessionsRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.agent.v1.WatchSessionsRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.agent.v1.WatchSessionsRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:agent.v1.WatchSessionsRequest)
      com.agent.v1.WatchSessionsRequestOrBuilder {
    // Construct using com.agent.v1.WatchSessionsRequest.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.agent.v1.WatchSessionsRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.agent.v1.WatchSessionsRequest> parser = PARSER;
        if (parser == null) {
          synchronized (com.agent.v1.WatchSessionsRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.agent.v1.WatchSessionsRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final com.agent.v1.WatchSessionsRequest DEFAULT_INSTANCE;
  static {
  ...
  public static com.agent.v1.WatchSessionsRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
