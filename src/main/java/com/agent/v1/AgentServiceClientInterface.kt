...
public interface AgentServiceClientInterface {
  ...
  public suspend fun watchSessions(headers: Headers = emptyMap()): ServerOnlyStreamInterface<WatchSessionsRequest, WatchSessionsResponse>
  ...
  public suspend fun discoverGatewayModels(request: DiscoverGatewayModelsRequest, headers: Headers = emptyMap()): ResponseMessage<DiscoverGatewayModelsResponse>
