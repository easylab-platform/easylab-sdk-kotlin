...
public inline fun registerExternalSandboxRequest(block: com.easylab.v1.RegisterExternalSandboxRequestKt.Dsl.() -> kotlin.Unit): com.easylab.v1.RegisterExternalSandboxRequest =
  com.easylab.v1.RegisterExternalSandboxRequestKt.Dsl._create(com.easylab.v1.RegisterExternalSandboxRequest.newBuilder()).apply { block() }._build()
/**
...
public object RegisterExternalSandboxRequestKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.easylab.v1.RegisterExternalSandboxRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.easylab.v1.RegisterExternalSandboxRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.easylab.v1.RegisterExternalSandboxRequest = _builder.build()
...
public inline fun com.easylab.v1.RegisterExternalSandboxRequest.copy(block: `com.easylab.v1`.RegisterExternalSandboxRequestKt.Dsl.() -> kotlin.Unit): com.easylab.v1.RegisterExternalSandboxRequest =
  `com.easylab.v1`.RegisterExternalSandboxRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
